...
QMMP_VERSION=0.12.23
QMMP_PLUGIN_PACK_VERSION=0.12.5
...
download_qmmp_tarball()
{
  ...
  wget -nc https://qmmp.ylsoftware.com/files/qmmp/0.12/qmmp-${QMMP_VERSION}.tar.bz2
...
download_plugins_tarball()
{
  ...
  wget -nc https://qmmp.ylsoftware.com/files/qmmp-plugin-pack/0.12/qmmp-plugin-pack-${QMMP_PLUGIN_PACK_VERSION}.tar.bz2
