...
download_qmmp_tarball()
{
  ...
  wget -nc https://qmmp.ylsoftware.com/files/qmmp/2.3/qmmp-${QMMP_VERSION}.tar.bz2
...
download_plugins_tarball()
{
  ...
  wget -nc https://qmmp.ylsoftware.com/files/qmmp-plugin-pack/2.3/qmmp-plugin-pack-${QMMP_PLUGIN_PACK_VERSION}.tar.bz2
