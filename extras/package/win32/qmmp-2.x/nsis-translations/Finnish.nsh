...
LangString text_default_simple_ui      ${LANG_Finnish} "Käytä yksinkertaista käyttöliittymää oletuksena"
...
LangString text_win64_warning          ${LANG_Finnish} "Ohjelmiston asentamiseen tarvitaan 64-bittinen Windows-käyttöjärjestelmä."
LangString text_enqueue                ${LANG_Finnish} "Aseta jonoon Qmmp:ssä"
LangString text_force_windows11_style  ${LANG_Finnish} "Käytä Windows 11 -tyyliä"
