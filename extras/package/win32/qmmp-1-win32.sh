...
QMMP_VERSION=1.7.2
QMMP_PLUGIN_PACK_VERSION=1.7.1
...
download_qmmp_tarball()
{
  ...
  wget -nc http://qmmp.ylsoftware.com/files/qmmp/1.7/qmmp-${QMMP_VERSION}.tar.bz2
...
download_plugins_tarball()
{
  ...
  wget -nc http://qmmp.ylsoftware.com/files/qmmp-plugin-pack/1.7/qmmp-plugin-pack-${QMMP_PLUGIN_PACK_VERSION}.tar.bz2
...
download_qmmp_svn()
{
  ...
  svn checkout svn://svn.code.sf.net/p/qmmp-dev/code/branches/qmmp-1.7 qmmp-${QMMP_VERSION}
  cd ..
}
...
download_plugins_svn()
{
  ...
  svn checkout svn://svn.code.sf.net/p/qmmp-dev/code/branches/qmmp-plugin-pack-1.7 qmmp-plugin-pack-${QMMP_PLUGIN_PACK_VERSION}
  cd ..
}
