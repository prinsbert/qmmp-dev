...
static void zoomFilterVisualFXWrapper_init (struct _VISUAL_FX *_this, PluginInfo *UNUSED(info))
{
...
static void zoomFilterVisualFXWrapper_apply (struct _VISUAL_FX *UNUSED(_this),
                                             Pixel *UNUSED(src),
                                             Pixel *UNUSED(dest),
                                             PluginInfo *UNUSED(info))
{
}
