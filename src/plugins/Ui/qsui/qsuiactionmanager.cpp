    ...
    QObject(parent)
{
    ...
    m_actions = {
        ...
        { SEEK_FORWARD_10, createAction(tr("+10 seconds"), u"seek_forward_10"_s, tr("Right"), u"media-seek-forward"_s) },
        ...
        { SEEK_BACKWARD_10, createAction(tr("-10 seconds"), u"seek_backward_10"_s, tr("Left"), u"media-seek-backward"_s) },
