...
#ifndef QSUIPLAYLISTBROWSER_H
#define QSUIPLAYLISTBROWSER_H
...
*/
class QSUiPlayListBrowser : public QWidget
{
Q_OBJECT
public:
    explicit QSUiPlayListBrowser(PlayListManager *manager, QWidget *parent = nullptr);
    ~QSUiPlayListBrowser();
