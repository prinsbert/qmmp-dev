...
PlayListTrack *PlayListContainer2::dequeue()
{
...
void PlayListContainer2::enqueue(PlayListTrack *track)
{
    m_queue.enqueue(track);
    updateQueueIndexes();
}

void PlayListContainer2::removeFromQueue(PlayListTrack *track)
{
    if(track->isQueued())
    {
...
void PlayListContainer2::clearQueue()
{
...
void PlayListContainer2::restoreQueue(const QList<PlayListTrack *> &tracks)
{
    m_queue.clear();
...
const QList<PlayListTrack *> &PlayListContainer2::queuedTracks() const
{
    return m_queue;
}

void PlayListContainer2::swapTrackNumbers(QList<PlayListItem *> *container, int index1, int index2)
{
...
void PlayListContainer2::updateQueueIndexes()
{
    for(int i = 0; i < m_queue.size(); ++i)
