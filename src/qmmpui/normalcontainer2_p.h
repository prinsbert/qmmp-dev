...
#ifndef NORMALCONTAINER2_P_H
#define NORMALCONTAINER2_P_H
 ...
 */
class NormalContainer2 : public PlayListContainer2
{
public:
    NormalContainer2();
    virtual ~NormalContainer2();
