 ...
 ***************************************************************************/
#ifndef BATCHTAGEDITORFACTORY_H
#define BATCHTAGEDITORFACTORY_H
...
class BatchTagEditorFactory : public QObject, public GeneralFactory
{
Q_OBJECT
