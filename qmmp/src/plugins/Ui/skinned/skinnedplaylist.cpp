...
SkinnedPlayList::SkinnedPlayList(PlayListManager *manager, SkinnedMainWindow *parent) : QWidget(parent)
{
    ...
    connect(m_plslider, &SkinnedPlayListSlider::sliderMoved, m_listWidget, &SkinnedListWidget::setViewPosition);
    connect(m_listWidget, &SkinnedListWidget::positionChanged, m_plslider, &SkinnedPlayListSlider::setPos);
