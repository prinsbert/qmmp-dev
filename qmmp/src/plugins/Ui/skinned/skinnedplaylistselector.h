...
#ifndef SKINNEDPLAYLISTSELECTOR_H
#define SKINNEDPLAYLISTSELECTOR_H
...
*/
class SkinnedPlayListSelector : public QWidget
{
Q_OBJECT
public:
    explicit SkinnedPlayListSelector(PlayListManager *manager, QWidget *parent = nullptr);
    ~SkinnedPlayListSelector();
    void readSettings();
...
#endif // SKINNEDPLAYLISTSELECTOR_H
